...
class WeightedJoystickController(Node):
    ...
    def build_allocation_matrix(self):
        ...
        thrusters = [
            [0.3015, -0.1798, -0.11253, -45, -135],  # T1_LFU
            [0.3015, -0.1798, 0.11253,  45, -135],  # T2_LFD
            [0.3015, 0.1798, -0.11253, -45, 135],  # T3_RFU
            [0.3015, 0.1798, 0.11253, 45, 135],  # T4_RFD
            [-0.3015, -0.1798, -0.11253, 45, 135], # T5_LBU
            [-0.3015, -0.1798, 0.11253, -45, 135], # T6_LBD
            [-0.3015, 0.1798, -0.11253,  45, -135], # T7_RBU
            [-0.3015, 0.1798, 0.11253, -45, -135], # T8_RBD
        ]
